...
* 🔥 **FAIL** The NameID.VERSION_STRING (nameID=5) value must follow the pattern "Version X.Y" with X.Y between 1.000 and 9.999. Current version string is: "3.4;862d1a785" [code: bad-version-strings]
...
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 1080, but got 660 instead [code: descent]
...
* ℹ️ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['3.4;862d1a785']
...
* ℹ️ **INFO** This font contains the following optional tables [gasp, GPOS, GSUB, prep, loca]
...
* 🍞 **PASS** Inter-Italic.ttf is named canonically.
