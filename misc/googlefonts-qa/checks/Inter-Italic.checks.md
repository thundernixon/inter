...
* :information_source: **INFO** This font contains the following optional tables [gasp, prep, GPOS, GSUB, loca]
...
* :bread: **PASS** Inter-Italic.ttf is named canonically.
...
* :bread: **PASS** Postscript name "Inter-Italic" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** Font fullname "Inter Italic" is identical in METADATA.pb and on the TTF file.
...
* :bread: **PASS** METADATA.pb font.full_name field contains font name in right format. ('Inter' in 'Inter Italic')
