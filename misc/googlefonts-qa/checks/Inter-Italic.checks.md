...
<details>
<summary><b>[132] Inter-Italic.ttf</b></summary>
<details>
...
objc[71715]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the "name" table: Expected "Inter Italic"  but got "Inter  Italic". [code: bad-entry]
...
* ℹ **INFO** This font contains the following optional tables [gasp, fpgm, loca, prep, GPOS, DSIG, GSUB, cvt ]
