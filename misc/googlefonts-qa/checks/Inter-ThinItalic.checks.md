...
<details>
<summary><b>[123] Inter-ThinItalic.ttf</b></summary>
<details>
...
objc[93404]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb font filename="Inter-ThinItalic.ttf" does not match post_script_name="Inter-ThinItalicBETA".
...
* 🔥 **FAIL** METADATA.pb postScriptName ("Inter-ThinItalicBETA") does not match correct font name format ("Inter Thin  BETA").
...
* 🔥 **FAIL** Font macStyle Italic bit is set but nameID 4 ("Inter Thin Italic BETA") is not ended with "Italic" [code: bad-fullfont-name]
...
* 🔥 **FAIL** OS/2 usWeightClass (100:"bad Google Fonts API weight value") does not match weight specified at METADATA.pb (100:"Thin").
...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Inter Thin' but got 'Inter Thin  BETA'.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter Thin Italic' but got 'Inter Thin Italic BETA'.
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-ThinItalic' but got 'Inter-ThinItalicBETA'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'Thin Italic' but got 'Thin Italic BETA'. [code: non-ribbi-bad-value]
...
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 3029, but got 2728 instead [code: ascent]
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 768, but got 680 instead [code: descent]
...
* 🔥 **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Inter Thin  BETA') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Inter Thin Italic BETA') [code: does-not]
...
Glyph name: uni03A8	Contours detected: 4	Expected: 1
Glyph name: uni03B2	Contours detected: 3	Expected: 2
Glyph name: uni03BB	Contours detected: 3	Expected: 1
...
Glyph name: uni04E9	Contours detected: 2	Expected: 3
Glyph name: uni04EB	Contours detected: 4	Expected: 5
...
[('uni0418', 2068.0928, 2048.0), ('uni040D', 2068.0928, 2048.0), ('uni0419', 2068.0928, 2048.0), ('uni04E2', 2068.0928, 2048.0), ('uni04E4', 2068.0928, 2048.0), ('uni048A', 2068.0928, 2048.0), ('uni0376', 2012.0928, 2048.0), ('uni01A7', 156.54050000000007, 355.0), ('uni01A7', 1627.1877, 1707.0), ('uni018C', 1546.0928, 2048.0), ('uni01A8', 50.90229999999997, 193.0), ('uni042F', 1586.0928, 2048.0), ('uni025C', 73.6572000000001, 452.0), ('uni025C', 1307.0788, 1308.0), ('uni025E', 1335.0788, 1308.0), ('uni025E', 9.740399999999909, 564.0), ('uni01B8', 1734.0928, 2048.0), ('uni01B9', 131.90339999999992, -106.0)]
...
* ℹ **INFO** This font contains the following optional tables [GPOS, prep, GSUB, gasp, fpgm, loca, cvt ]
...
* 🍞 **PASS** Font fullname "Inter Thin Italic BETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ('Inter' in 'Inter Thin Italic BETA')
