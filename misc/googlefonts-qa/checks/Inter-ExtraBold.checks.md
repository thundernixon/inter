...
<details>
<summary><b>[123] Inter-ExtraBold.ttf</b></summary>
<details>
...
objc[92401]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** Unmatched fullname in font: TTF has "Inter ExtraBold" while METADATA.pb has "Inter Extra Bold". [code: mismatch]
...
* 🔥 **FAIL** METADATA.pb: Fullname ("Inter Extra Bold") does not match name table entry "Inter ExtraBold" ! [code: fullname-mismatch]
...
* ℹ **INFO** This font contains the following optional tables [prep, fpgm, gasp, loca, cvt , GSUB, GPOS]
...
* 🍞 **PASS** Inter-ExtraBold.ttf is named canonically.
...
* 🍞 **PASS** Postscript name "Inter-ExtraBold" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ('Inter' in 'Inter Extra Bold')
