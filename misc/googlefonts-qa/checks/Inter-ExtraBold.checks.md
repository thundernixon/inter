...
<details>
<summary><b>[132] Inter-ExtraBold.ttf</b></summary>
<details>
...
objc[71324]: Objective-C garbage collection is no longer supported.
...
* ℹ **INFO** This font contains the following optional tables [cvt , loca, DSIG, gasp, GPOS, fpgm, prep, GSUB]
...
* 🍞 **PASS** Font fullname "Inter ExtraBold" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ("Inter" in "Inter ExtraBold")
