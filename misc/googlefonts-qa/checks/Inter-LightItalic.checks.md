...
<details>
<summary><b>[123] Inter-LightItalic.ttf</b></summary>
<details>
...
objc[92848]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb font filename="Inter-LightItalic.ttf" does not match post_script_name="Inter-LightItalicBETA".
...
* 🔥 **FAIL** METADATA.pb postScriptName ("Inter-LightItalicBETA") does not match correct font name format ("Inter Light  BETA").
...
* 🔥 **FAIL** Font macStyle Italic bit is set but nameID 4 ("Inter Light Italic BETA") is not ended with "Italic" [code: bad-fullfont-name]
...
* 🔥 **FAIL** METADATA.pb: Mismatch between postScriptName ("Inter-LightItalicBETA") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Inter Light' but got 'Inter Light  BETA'.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter Light Italic' but got 'Inter Light Italic BETA'.
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-LightItalic' but got 'Inter-LightItalicBETA'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'Light Italic' but got 'Light Italic BETA'. [code: non-ribbi-bad-value]
...
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 3018, but got 2728 instead [code: ascent]
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 765, but got 680 instead [code: descent]
...
* 🔥 **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Inter Light  BETA') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Inter Light Italic BETA') [code: does-not]
...
Glyph name: uni01A2	Contours detected: 1	Expected: 2
...
Glyph name: uni0240	Contours detected: 2	Expected: 1
...
[('uni1E12', 134.77710000000002, -555.0), ('uni00CE', 1018.4124999999999, 2238.0), ('uniE013', 1233.4125, 2238.0), ('uni0134', 1797.4125, 2238.0), ('uni0418', 2077.0928, 2048.0), ('uni040D', 2077.0928, 2048.0), ('uni0419', 2077.0928, 2048.0), ('uni04E2', 2077.0928, 2048.0), ('uni04E4', 2077.0928, 2048.0), ('uni048A', 2077.0928, 2048.0), ('uni0376', 2058.0928, 2048.0), ('uni1E70', 269.7771, -555.0), ('uni018C', 1634.0928, 2048.0), ('uni00EE', 898.4124999999999, 1729.0), ('uni00EE', 69.77710000000002, 1715.0), ('uni0135', 893.4124999999999, 1726.0), ('uni1E3D', -297.2229, -555.0), ('uniE05C', -289.2229, -555.0), ('uni01A8', 59.70129999999995, 283.0), ('uni1E71', -42.22289999999998, -555.0), ('uni042F', 1687.0928, 2048.0), ('uni025C', 1384.0654, 1314.0), ('uni025E', 1402.0654, 1314.0), ('uni02C6', 1194.4125, 1726.0), ('uni02C6', 365.7771, 1712.0), ('uni0302', -210.5875000000001, 1726.0), ('uni0302', -1039.2229, 1712.0), ('uni032D', -571.5875000000001, -541.0), ('uni032D', -1400.2229, -555.0), ('uni01B8', 1793.0928, 2048.0), ('uni01B9', 88.91010000000006, -109.0)]
...
* ℹ **INFO** This font contains the following optional tables [loca, prep, cvt , GSUB, gasp, GPOS, fpgm]
...
* 🍞 **PASS** Inter-LightItalic.ttf is named canonically.
...
* 🍞 **PASS** Postscript name "Inter-LightItalicBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** Font fullname "Inter Light Italic BETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ('Inter' in 'Inter Light Italic BETA')
