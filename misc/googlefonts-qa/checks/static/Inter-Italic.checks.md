...
objc[57108]: Objective-C garbage collection is no longer supported.
...
* ℹ **INFO** This font contains the following optional tables [cvt , gasp, GPOS, fpgm, loca, prep, GSUB]
...
* 🍞 **PASS** static/Inter-Italic.ttf is named canonically.
