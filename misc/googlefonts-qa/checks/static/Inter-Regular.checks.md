...
objc[57569]: Objective-C garbage collection is no longer supported.
...
* ℹ **INFO** This font contains the following optional tables [prep, loca, gasp, GPOS, GSUB, fpgm, cvt ]
...
* 🍞 **PASS** static/Inter-Regular.ttf is named canonically.
