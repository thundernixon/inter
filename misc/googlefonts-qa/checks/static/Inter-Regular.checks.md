...
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 1084, but got 660 instead [code: descent]
...
* :information_source: **INFO** This font contains the following optional tables [loca, fpgm, cvt , prep, GPOS, GSUB, gasp]
...
* :bread: **PASS** static/Inter-Regular.ttf is named canonically.
