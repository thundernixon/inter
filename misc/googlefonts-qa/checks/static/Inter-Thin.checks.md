...
objc[57899]: Objective-C garbage collection is no longer supported.
...
* ℹ **INFO** This font contains the following optional tables [fpgm, GPOS, cvt , loca, prep, GSUB, gasp]
...
* 🍞 **PASS** static/Inter-Thin.ttf is named canonically.
