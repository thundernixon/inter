...
<details>
<summary><b>[116] Inter-Thin.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter Thin' but got 'Inter Thin BETA'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-Thin' but got 'Inter-ThinBETA'.
...
* :fire: **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'Thin' but got 'Thin BETA'. [code: non-ribbi-bad-value]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Thin BETA' / SUBFAMILY_NAME = 'Regular'
...
[('uni031F', -532.0, -517.256), ('uni031F', -672.0, -517.256)]
...
* :information_source: **INFO** This font contains the following optional tables [prep, loca, GSUB, fpgm, GPOS, cvt , gasp]
...
* :bread: **PASS** static/Inter-Thin.ttf is named canonically.
