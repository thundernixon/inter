...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter SemiBold Italic' but got 'Inter Semi Bold Italic'.
...
* :fire: **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'SemiBold Italic' but got 'Semi Bold Italic'. [code: non-ribbi-bad-value]
...
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 1126, but got 660 instead [code: descent]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Semi Bold' / SUBFAMILY_NAME = 'Italic'
...
|  | static/Inter-SemiBoldItalic.ttf |
|:--- | ---:|
| Dehinted Size | 259.7kb |
| Hinted Size | 349.5kb |
| Increase | 89.8kb |
| Change   | 34.6 % |
...
* :information_source: **INFO** This font contains the following optional tables [prep, GPOS, fpgm, gasp, GSUB, loca, cvt ]
...
* :bread: **PASS** static/Inter-SemiBoldItalic.ttf is named canonically.
