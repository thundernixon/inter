...
objc[56540]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraBold' but got 'Inter Extra Bold'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraBold' but got 'Extra Bold'. [code: non-ribbi-bad-value]
...
* ℹ **INFO** This font contains the following optional tables [GPOS, prep, cvt , loca, fpgm, gasp, GSUB]
...
* 🍞 **PASS** static/Inter-ExtraBold.ttf is named canonically.
