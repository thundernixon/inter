...
<details>
<summary><b>[116] Inter-ExtraBold.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraBold' but got 'Inter Extra Bold'.
...
* :fire: **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraBold' but got 'Extra Bold'. [code: non-ribbi-bad-value]
...
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 1174, but got 660 instead [code: descent]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Extra Bold' / SUBFAMILY_NAME = 'Regular'
...
[('uni031F', -675.0, -53.672000000000025), ('uni031F', -970.0, -53.672000000000025)]
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, prep, GSUB, cvt , fpgm, loca, gasp]
...
* :bread: **PASS** static/Inter-ExtraBold.ttf is named canonically.
