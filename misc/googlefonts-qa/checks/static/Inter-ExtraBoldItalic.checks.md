...
objc[56622]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraBold' but got 'Inter Extra Bold'.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraBold Italic' but got 'Inter Extra Bold Italic'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraBold Italic' but got 'Extra Bold Italic'. [code: non-ribbi-bad-value]
...
* ℹ **INFO** This font contains the following optional tables [loca, GSUB, fpgm, prep, gasp, cvt , GPOS]
...
* 🍞 **PASS** static/Inter-ExtraBoldItalic.ttf is named canonically.
