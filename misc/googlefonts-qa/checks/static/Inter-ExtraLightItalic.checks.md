...
<details>
<summary><b>[116] Inter-ExtraLightItalic.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight' but got 'Inter Extra Light  BETA'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight Italic' but got 'Inter Extra Light Italic BETA'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-ExtraLightItalic' but got 'Inter-ExtraLightItalicBETA'.
...
* :fire: **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraLight Italic' but got 'Extra Light Italic BETA'. [code: non-ribbi-bad-value]
...
* :fire: **FAIL** OS/2.usWinAscent value should be equal or greater than 3023, but got 2708 instead [code: ascent]
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 1048, but got 660 instead [code: descent]
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Inter Extra Light  BETA') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Inter Extra Light Italic BETA') [code: does-not]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Extra Light  BETA' / SUBFAMILY_NAME = 'Italic'
...
[('uni0418', 2069.0928, 2048.0), ('uni040D', 2069.0928, 2048.0), ('uni0419', 2069.0928, 2048.0), ('uni04E2', 2069.0928, 2048.0), ('uni04E4', 2069.0928, 2048.0), ('uni048A', 2069.0928, 2048.0), ('uni0376', 2032.0928, 2048.0), ('uni01A7', 133.51369999999997, 367.0), ('uni1E70', 277.72350000000006, -539.0), ('uni018C', 1590.0928, 2048.0), ('uni00EE', 77.72349999999994, 1715.0), ('uni1E3D', -285.27649999999994, -539.0), ('uni1E3D.ss02', -271.27649999999994, -539.0), ('uni01A8', 1246.497, 1270.0), ('uni1E71', -90.27649999999994, -539.0), ('uni042F', 1637.0928, 2048.0), ('uni025C', 1346.0721, 1311.0), ('uni025E', 1369.0721, 1311.0), ('uni02C6', 367.72349999999994, 1714.0), ('uni0302', -971.2765, 1714.0), ('uni032D', -1346.2765, -539.0), ('uni01B8', 1763.0928, 2048.0), ('uni01B8', -37.15409999999997, 69.0), ('uni01B9', 110.57230000000004, -107.0), ('uni031F', -568.0, -103.50799999999992), ('uni031F', -733.0, -103.50799999999992)]
...
|  | static/Inter-ExtraLightItalic.ttf |
|:--- | ---:|
| Dehinted Size | 265.6kb |
| Hinted Size | 346.2kb |
| Increase | 80.6kb |
| Change   | 30.4 % |
...
* :information_source: **INFO** This font contains the following optional tables [loca, prep, cvt , fpgm, gasp, GPOS, GSUB]
...
* :bread: **PASS** static/Inter-ExtraLightItalic.ttf is named canonically.
