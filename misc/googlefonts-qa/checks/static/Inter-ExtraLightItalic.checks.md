...
objc[56968]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight' but got 'Inter Extra Light  BETA'.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight Italic' but got 'Inter Extra Light Italic BETA'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraLight Italic' but got 'Extra Light Italic BETA'. [code: non-ribbi-bad-value]
...
* 🔥 **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Inter Extra Light  BETA') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Inter Extra Light Italic BETA') [code: does-not]
...
* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Extra Light  BETA' / SUBFAMILY_NAME = 'Italic'
...
* ℹ **INFO** This font contains the following optional tables [GPOS, loca, cvt , prep, gasp, fpgm, GSUB]
...
* 🍞 **PASS** static/Inter-ExtraLightItalic.ttf is named canonically.
