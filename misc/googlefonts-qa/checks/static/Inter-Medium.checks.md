...
objc[57439]: Objective-C garbage collection is no longer supported.
...
* ℹ **INFO** This font contains the following optional tables [loca, cvt , gasp, GSUB, fpgm, prep, GPOS]
