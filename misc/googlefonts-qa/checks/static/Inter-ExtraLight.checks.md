...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight' but got 'Inter Extra Light BETA'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-ExtraLight' but got 'Inter-ExtraLightBETA'.
...
* :fire: **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraLight' but got 'Extra Light BETA'. [code: non-ribbi-bad-value]
...
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 1049, but got 660 instead [code: descent]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Extra Light BETA' / SUBFAMILY_NAME = 'Regular'
...
[('uni042E', 276.79999999999995, 935.0), ('uni042E', 276.79999999999995, 1051.0), ('uni031F', -552.0, -103.50799999999992), ('uni031F', -715.0, -103.50799999999992)]
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, loca, fpgm, gasp, cvt , GSUB, prep]
...
* :bread: **PASS** static/Inter-ExtraLight.ttf is named canonically.
