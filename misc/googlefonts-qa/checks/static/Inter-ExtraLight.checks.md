...
objc[76908]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight' but got 'Inter Extra Light BETA'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraLight' but got 'Extra Light BETA'. [code: non-ribbi-bad-value]
...
* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Extra Light BETA' / SUBFAMILY_NAME = 'Regular'
...
* ℹ **INFO** This font contains the following optional tables [fpgm, cvt , gasp, GSUB, prep, loca, GPOS]
...
* 🍞 **PASS** static/Inter-ExtraLight.ttf is named canonically.
