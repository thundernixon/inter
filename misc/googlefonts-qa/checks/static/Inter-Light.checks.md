...
objc[57292]: Objective-C garbage collection is no longer supported.
...
* ℹ **INFO** This font contains the following optional tables [gasp, fpgm, cvt , GPOS, prep, loca, GSUB]
...
* 🍞 **PASS** static/Inter-Light.ttf is named canonically.
