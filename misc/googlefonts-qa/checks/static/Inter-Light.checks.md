...
<details>
<summary><b>[116] Inter-Light.ttf</b></summary>
<details>
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter Light' but got 'Inter Light BETA'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-Light' but got 'Inter-LightBETA'.
...
* :fire: **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'Light' but got 'Light BETA'. [code: non-ribbi-bad-value]
...
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 1067, but got 660 instead [code: descent]
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Light BETA' / SUBFAMILY_NAME = 'Regular'
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, fpgm, prep, loca, cvt , GSUB, gasp]
...
* :bread: **PASS** static/Inter-Light.ttf is named canonically.
