...
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 1103, but got 660 instead [code: descent]
...
Glyph name: uni2192	Contours detected: 2	Expected: 1
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, prep, fpgm, GSUB, loca, cvt , gasp]
...
* :bread: **PASS** static/Inter-MediumItalic.ttf is named canonically.
