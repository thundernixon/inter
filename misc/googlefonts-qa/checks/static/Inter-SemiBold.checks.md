...
objc[57724]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter SemiBold' but got 'Inter Semi Bold'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'SemiBold' but got 'Semi Bold'. [code: non-ribbi-bad-value]
...
* ℹ **INFO** This font contains the following optional tables [GPOS, prep, gasp, cvt , fpgm, loca, GSUB]
...
* 🍞 **PASS** static/Inter-SemiBold.ttf is named canonically.
