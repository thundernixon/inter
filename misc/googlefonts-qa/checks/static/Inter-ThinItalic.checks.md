...
* :zzz: **SKIP** Font family at 'static' lacks a METADATA.pb file.
...
<details>
<summary><b>[116] Inter-ThinItalic.ttf</b></summary>
<details>
...
* :fire: **FAIL** The NameID.VERSION_STRING (nameID=5) value must follow the pattern "Version X.Y" with X.Y between 1.000 and 9.999. Current version string is: "3.4;9d48272f9" [code: bad-version-strings]

</details>
<details>
<summary>:fire: <b>FAIL:</b> Stricter unitsPerEm criteria for Google Fonts. </summary>

* [com.google.fonts/check/116](https://github.com/googlefonts/fontbakery/search?q=com.google.fonts/check/116)
* :fire: **FAIL** Font em size (unitsPerEm) is 2816. If possible, please consider using 1000 or even 2000 (which is ideal for Variable Fonts). The acceptable values for unitsPerEm, though, are: [16, 32, 64, 128, 256, 500, 512, 1000, 1024, 2000, 2048].
...
* :fire: **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Inter Thin' but got 'Inter Thin  BETA'.
...
* :fire: **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter Thin Italic' but got 'Inter Thin Italic BETA'.
...
* :fire: **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-ThinItalic' but got 'Inter-ThinItalicBETA'.
...
* :fire: **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'Thin Italic' but got 'Thin Italic BETA'. [code: non-ribbi-bad-value]
...
* :fire: **FAIL** OS/2.usWinAscent value should be equal or greater than 3029, but got 2708 instead [code: ascent]
* :fire: **FAIL** OS/2.usWinDescent value should be equal or greater than 1032, but got 660 instead [code: descent]
...
* :fire: **FAIL** head version is ('3', '004'), name version string for platform 3, encoding 1, is ('3', '400') [code: mismatch]
...
* :fire: **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Inter Thin  BETA') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Inter Thin Italic BETA') [code: does-not]
...
* :warning: **WARN** OS/2 VendorID value 'RSMS' is not a known registered id. You should set it to your own 4 character code, and register that code with Microsoft at https://www.microsoft.com/typography/links/vendorlist.aspx [code: unknown]
...
<details>
<summary>:warning: <b>WARN:</b> Checking unitsPerEm value is reasonable.</summary>
...
* :warning: **WARN** The combined length of family and style exceeds 20 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter Thin  BETA' / SUBFAMILY_NAME = 'Italic'
...
[('uni0418', 2062.0928, 2048.0), ('uni040D', 2062.0928, 2048.0), ('uni0419', 2062.0928, 2048.0), ('uni04E2', 2062.0928, 2048.0), ('uni04E4', 2062.0928, 2048.0), ('uni048A', 2062.0928, 2048.0), ('uni0376', 2006.0928, 2048.0), ('uni01A7', 156.54050000000007, 355.0), ('uni01A7', 1627.1877, 1707.0), ('uni018C', 1546.0928, 2048.0), ('uni01A8', 50.90229999999997, 193.0), ('uni042F', 1586.0928, 2048.0), ('uni025C', 73.6572000000001, 452.0), ('uni025C', 1307.0788, 1308.0), ('uni025E', 1335.0788, 1308.0), ('uni025E', 9.740399999999909, 564.0), ('uni01B8', 1734.0928, 2048.0), ('uni01B9', 131.90339999999992, -106.0), ('uni031F', -620.0, -517.256), ('uni031F', -760.0, -517.256)]
...
|  | static/Inter-ThinItalic.ttf |
|:--- | ---:|
| Dehinted Size | 268.6kb |
| Hinted Size | 345.3kb |
| Increase | 76.7kb |
| Change   | 28.6 % |
...
* :information_source: **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['3.4;9d48272f9']
...
* :information_source: **INFO** Version string is: "3.4;9d48272f9"
...
* :information_source: **INFO** This font contains the following optional tables [GPOS, GSUB, loca, cvt , fpgm, prep, gasp]
...
* :bread: **PASS** static/Inter-ThinItalic.ttf is named canonically.
...
* :bread: **PASS** Value of post.italicAngle is -9.4 with style='ThinItalic'.
