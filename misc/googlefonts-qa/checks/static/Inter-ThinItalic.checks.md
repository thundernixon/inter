...
objc[57980]: Objective-C garbage collection is no longer supported.
...
* ℹ **INFO** This font contains the following optional tables [cvt , gasp, GSUB, loca, fpgm, prep, GPOS]
...
* 🍞 **PASS** static/Inter-ThinItalic.ttf is named canonically.
