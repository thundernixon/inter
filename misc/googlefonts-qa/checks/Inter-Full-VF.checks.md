...
* ℹ **INFO** fontbakery (0.7.9)  - Well designed Font QA tool, written in Python 3
  INSTALLED: 0.7.9 (latest)
...
objc[65403]: Objective-C garbage collection is no longer supported.
...
But instead we have got: 'Copyright 2019 The Inter project authors'
...
* 🔥 **FAIL** METADATA.pb: filename field ("Inter[slnt,wght].ttf") does not match canonical name "Inter-Roman-VF.ttf".
...
* 🔥 **FAIL** Copyright field for this font on METADATA.pb ('Copyright 2019 the Inter project authors (https://github.com/rsms/inter)') differs from a copyright notice entry on the name table: 'Copyright 2019 The Inter project authors'
...
* 🔥 **FAIL** Instance name "Extra Light" is incorrect. It should be "ExtraLight"
* 🔥 **FAIL** Instance name "Extra Light Italic" is incorrect. It should be "ExtraLight Italic"
* 🔥 **FAIL** Instance name "Semi Bold" is incorrect. It should be "SemiBold"
* 🔥 **FAIL** Instance name "Semi Bold Italic" is incorrect. It should be "SemiBold Italic"
* 🔥 **FAIL** Instance name "Extra Bold" is incorrect. It should be "ExtraBold"
* 🔥 **FAIL** Instance name "Extra Bold Italic" is incorrect. It should be "ExtraBold Italic"
...
* ℹ **INFO** Found a git repo URL: https://github.com/rsms/inter/
* 🍞 **PASS** Looks great!
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 3.008;git-5bab7b1d7']
...
* ℹ **INFO** Version string is: "Version 3.008;git-5bab7b1d7"
...
* 🍞 **PASS** Inter[slnt,wght].ttf is named canonically.
...
* [com.google.fonts/check/wdth_valid_range](https://font-bakery.readthedocs.io/en/latest/fontbakery/profiles/fvar.html#com.google.fonts/check/wdth_valid_range)
* 🍞 **PASS** OK
