...
objc[31564]: Objective-C garbage collection is no longer supported.
...
* ℹ **INFO** This font contains the following optional tables [DSIG, prep, loca, gasp, GSUB, GPOS]
...
* 🍞 **PASS** Font fullname "Inter" is identical in METADATA.pb and on the TTF file.
* 🍞 **PASS** Font fullname "Inter" is identical in METADATA.pb and on the TTF file.
