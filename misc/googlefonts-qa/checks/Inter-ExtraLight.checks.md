...
<details>
<summary><b>[123] Inter-ExtraLight.ttf</b></summary>
<details>
...
objc[87564]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** Unmatched fullname in font: TTF has "Inter ExtraLight BETA" while METADATA.pb has "Inter Extra Light BETA". [code: mismatch]
...
* 🔥 **FAIL** METADATA.pb font filename="Inter-ExtraLight.ttf" does not match post_script_name="Inter-ExtraLightBETA".
...
* 🔥 **FAIL** METADATA.pb: Fullname ("Inter Extra Light BETA") does not match name table entry "Inter ExtraLight BETA" ! [code: fullname-mismatch]
...
* 🔥 **FAIL** METADATA.pb: Mismatch between postScriptName ("Inter-ExtraLightBETA") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight' but got 'Inter ExtraLight BETA'.
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-ExtraLight' but got 'Inter-ExtraLightBETA'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraLight' but got 'ExtraLight BETA'. [code: non-ribbi-bad-value]
...
* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter ExtraLight BETA' / SUBFAMILY_NAME = 'Regular'
...
[('uni042E', 276.79999999999995, 935.0), ('uni042E', 276.79999999999995, 1051.0)]
...
* ℹ **INFO** This font contains the following optional tables [fpgm, GPOS, prep, GSUB, loca, cvt , gasp]
...
* 🍞 **PASS** Inter-ExtraLight.ttf is named canonically.
...
* 🍞 **PASS** Postscript name "Inter-ExtraLightBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ('Inter' in 'Inter Extra Light BETA')
