...
<details>
<summary><b>[132] Inter-ExtraLight.ttf</b></summary>
<details>
...
objc[71557]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb font filename = "Inter-ExtraLight.ttf" does not match post_script_name="Inter-ExtraLightBETA". [code: mismatch]
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the "name" table: Expected "Inter ExtraLight"  but got "Inter ExtraLightBETA". [code: bad-entry]
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the "name" table: Expected "Inter-ExtraLight" but got "Inter-ExtraLightBETA". [code: bad-entry]
...
* 🔥 **FAIL** TYPOGRAPHIC_SUBFAMILY_NAME for Win "ExtraLightBETA" is incorrect. It must be "ExtraLight". [code: bad-typo-win]
...
Glyph name: uni0494	Contours detected: 2	Expected: 1
Glyph name: uni04B1	Contours detected: 2	Expected: 1
Glyph name: uni1ED1	Contours detected: 6	Expected: 4 [code: contour-count]
...
* ℹ **INFO** This font contains the following optional tables [GSUB, cvt , fpgm, loca, DSIG, gasp, prep, GPOS]
...
* 🍞 **PASS** Font fullname "Inter ExtraLightBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ("Inter" in "Inter ExtraLightBETA")
