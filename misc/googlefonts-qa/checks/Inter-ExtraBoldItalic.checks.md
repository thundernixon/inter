...
<details>
<summary><b>[132] Inter-ExtraBoldItalic.ttf</b></summary>
<details>
...
objc[71470]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 912, but got 680 instead [code: descent]
...
Glyph name: uni0197	Contours detected: 2	Expected: 1
Glyph name: uni1E1D	Contours detected: 4	Expected: 3
Glyph name: uni0494	Contours detected: 2	Expected: 1 [code: contour-count]
...
* ℹ **INFO** This font contains the following optional tables [gasp, cvt , fpgm, prep, loca, GPOS, GSUB, DSIG]
...
* 🍞 **PASS** Font fullname "Inter ExtraBold Italic" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ("Inter" in "Inter ExtraBold Italic")
