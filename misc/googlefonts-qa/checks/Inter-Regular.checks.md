...
objc[98602]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb: filename field ("Inter-Regular.ttf") does not match canonical name "Inter-Roman-VF.ttf".
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 3.006;git-b121cb821']
...
* ℹ **INFO** Version string is: "Version 3.006;git-b121cb821"
...
* ℹ **INFO** This font contains the following optional tables [gasp, loca, GPOS, DSIG, GSUB, prep]
