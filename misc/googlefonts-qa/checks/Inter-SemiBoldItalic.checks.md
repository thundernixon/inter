...
<details>
<summary><b>[132] Inter-SemiBoldItalic.ttf</b></summary>
<details>
...
objc[72292]: Objective-C garbage collection is no longer supported.
...
Glyph name: uni04B1	Contours detected: 2	Expected: 1
Glyph name: uni023E	Contours detected: 1	Expected: 2
Glyph name: uni0243	Contours detected: 4	Expected: 3 [code: contour-count]
...
* ⚠ **WARN** The following glyphs have coordinates which are out of bounds:
	* ('uni0186', 120.25240000000008, 484.0)
	* ('uni0250', 110, 356)
	* ('uni2E18', -21, -172)
	* ('uni01B8', -18.7962, 58.0) and ('uni03FF', 120.25240000000008, 484.0)
...
* ℹ **INFO** This font contains the following optional tables [cvt , DSIG, gasp, fpgm, loca, prep, GSUB, GPOS]
...
* 🍞 **PASS** Font fullname "Inter SemiBold Italic" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ("Inter" in "Inter SemiBold Italic")
