...
<details>
<summary><b>[132] Inter-Thin.ttf</b></summary>
<details>
...
objc[72379]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb font filename = "Inter-Thin.ttf" does not match post_script_name="Inter-ThinBETA". [code: mismatch]
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the "name" table: Expected "Inter Thin"  but got "Inter ThinBETA". [code: bad-entry]
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the "name" table: Expected "Inter-Thin" but got "Inter-ThinBETA". [code: bad-entry]
...
* 🔥 **FAIL** TYPOGRAPHIC_SUBFAMILY_NAME for Win "ThinBETA" is incorrect. It must be "Thin". [code: bad-typo-win]
...
Glyph name: uni0228	Contours detected: 2	Expected: 1
Glyph name: uni0462	Contours detected: 3	Expected: 2
Glyph name: uni052F	Contours detected: 2	Expected: 1 [code: contour-count]
...
* ℹ **INFO** This font contains the following optional tables [cvt , DSIG, fpgm, loca, gasp, GSUB, GPOS, prep]
...
* 🍞 **PASS** Font fullname "Inter ThinBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ("Inter" in "Inter ThinBETA")
