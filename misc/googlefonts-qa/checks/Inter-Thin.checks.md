...
<details>
<summary><b>[123] Inter-Thin.ttf</b></summary>
<details>
...
objc[88440]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb font filename="Inter-Thin.ttf" does not match post_script_name="Inter-ThinBETA".
...
* 🔥 **FAIL** METADATA.pb: Mismatch between postScriptName ("Inter-ThinBETA") and weight value (100). The name must be ended with "Thin" or "ThinItalic".
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter Thin' but got 'Inter Thin BETA'.
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-Thin' but got 'Inter-ThinBETA'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'Thin' but got 'Thin BETA'. [code: non-ribbi-bad-value]
...
Glyph name: uni03BB	Contours detected: 4	Expected: 1
...
* ℹ **INFO** This font contains the following optional tables [loca, GSUB, prep, fpgm, gasp, cvt , GPOS]
...
* 🍞 **PASS** Inter-Thin.ttf is named canonically.
...
* 🍞 **PASS** Postscript name "Inter-ThinBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** Font fullname "Inter Thin BETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ('Inter' in 'Inter Thin BETA')
