...
<details>
<summary><b>[123] Inter-Light.ttf</b></summary>
<details>
...
objc[87799]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb font filename="Inter-Light.ttf" does not match post_script_name="Inter-LightBETA".
...
* 🔥 **FAIL** METADATA.pb: Mismatch between postScriptName ("Inter-LightBETA") and weight value (300). The name must be ended with "Light" or "LightItalic".
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter Light' but got 'Inter Light BETA'.
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-Light' but got 'Inter-LightBETA'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'Light' but got 'Light BETA'. [code: non-ribbi-bad-value]
...
* ℹ **INFO** This font contains the following optional tables [cvt , loca, GPOS, fpgm, gasp, GSUB, prep]
...
* 🍞 **PASS** Inter-Light.ttf is named canonically.
...
* 🍞 **PASS** Postscript name "Inter-LightBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** Font fullname "Inter Light BETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ('Inter' in 'Inter Light BETA')
