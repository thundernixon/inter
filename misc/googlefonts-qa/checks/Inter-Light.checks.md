...
<details>
<summary><b>[132] Inter-Light.ttf</b></summary>
<details>
...
objc[71802]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb font filename = "Inter-Light.ttf" does not match post_script_name="Inter-LightBETA". [code: mismatch]
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the "name" table: Expected "Inter Light"  but got "Inter LightBETA". [code: bad-entry]
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the "name" table: Expected "Inter-Light" but got "Inter-LightBETA". [code: bad-entry]
...
* 🔥 **FAIL** TYPOGRAPHIC_SUBFAMILY_NAME for Win "LightBETA" is incorrect. It must be "Light". [code: bad-typo-win]
...
Glyph name: uni048C	Contours detected: 3	Expected: 2
Glyph name: uni0189	Contours detected: 3	Expected: 2
Glyph name: uni0404	Contours detected: 2	Expected: 1 [code: contour-count]
...
* ℹ **INFO** This font contains the following optional tables [GSUB, gasp, prep, fpgm, GPOS, loca, DSIG, cvt ]
...
* 🍞 **PASS** Font fullname "Inter LightBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ("Inter" in "Inter LightBETA")
