...
<details>
<summary>💔 <b>ERROR:</b> Directory name in GFonts repo structure must match NameID 1 of the regular.</summary>
...
* 💔 **ERROR** Failed with KeyError: "'name' table not found"
* 🔥 **FAIL** The font seems to lack a regular.

</details>
<details>
<summary>🔥 <b>FAIL:</b> METADATA.pb: check if fonts field only has unique "full_name" values.</summary>
...
* 🔥 **FAIL** Found duplicated "full_name" values in METADATA.pb fonts field.

</details>
<details>
<summary>🔥 <b>FAIL:</b> METADATA.pb: check if fonts field only contains unique style:weight pairs.</summary>
...
* 🔥 **FAIL** Found duplicated style:weight pair in METADATA.pb fonts field.
...
<details>
<summary><b>[123] Inter-ExtraLightItalic.ttf</b></summary>
<details>
...
objc[92617]: Objective-C garbage collection is no longer supported.
...
<details>
<summary>🔥 <b>FAIL:</b> METADATA.pb font.full_name value matches fullname declared on the name table?</summary>
...
* 🔥 **FAIL** Unmatched fullname in font: TTF has "Inter ExtraLight Italic BETA" while METADATA.pb has "Inter Extra Light Italic BETA". [code: mismatch]
...
* 🔥 **FAIL** METADATA.pb font filename="Inter-ExtraLightItalic.ttf" does not match post_script_name="Inter-ExtraLightItalicBETA".
...
* 🔥 **FAIL** METADATA.pb postScriptName ("Inter-ExtraLightItalicBETA") does not match correct font name format ("Inter ExtraLight  BETA").
...
* 🔥 **FAIL** Font macStyle Italic bit is set but nameID 4 ("Inter ExtraLight Italic BETA") is not ended with "Italic" [code: bad-fullfont-name]

</details>
<details>
<summary>🔥 <b>FAIL:</b> METADATA.pb font.name and font.full_name fields match the values declared on the name table?</summary>
...
* 🔥 **FAIL** METADATA.pb: Fullname ("Inter Extra Light Italic BETA") does not match name table entry "Inter ExtraLight Italic BETA" ! [code: fullname-mismatch]
...
* 🔥 **FAIL** OS/2 usWeightClass (200:"bad Google Fonts API weight value") does not match weight specified at METADATA.pb (200:"ExtraLight").
...
* 🔥 **FAIL** METADATA.pb: Mismatch between postScriptName ("Inter-ExtraLightItalicBETA") and weight value (200). The name must be ended with "ExtraLight" or "ExtraLightItalic".
...
* 🔥 **FAIL** The value of post.italicAngle is positive, which is likely a mistake and should become negative, from 9.4 to -9.4. [code: positive]
...
* 🔥 **FAIL** Copyright field for this font on METADATA.pb ('Copyright 2019 the Inter project authors (https://github.com/rsms/inter)') differs from a copyright notice entry on the name table: 'Copyright 2019 the Inter Project Authors (https://github.com/rsms/inter)'
...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight' but got 'Inter ExtraLight  BETA'.
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the 'name' table: Expected 'Inter ExtraLight Italic' but got 'Inter ExtraLight Italic BETA'.
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the 'name' table: Expected 'Inter-ExtraLightItalic' but got 'Inter-ExtraLightItalicBETA'.
...
* 🔥 **FAIL** Entry [TYPOGRAPHIC_SUBFAMILY_NAME(17):WINDOWS(3)] on the 'name' table: Expected 'ExtraLight Italic' but got 'ExtraLight Italic BETA'. [code: non-ribbi-bad-value]
...
* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 3023, but got 2728 instead [code: ascent]
* 🔥 **FAIL** OS/2.usWinDescent value should be equal or greater than 767, but got 680 instead [code: descent]
...
* 🔥 **FAIL**  On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Inter ExtraLight  BETA') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Inter ExtraLight Italic BETA') [code: does-not]
...
Glyph name: uni0220	Contours detected: 2	Expected: 1
Glyph name: uni0228	Contours detected: 2	Expected: 1
Glyph name: uni0229	Contours detected: 3	Expected: 2
Glyph name: uni023D	Contours detected: 2	Expected: 1
Glyph name: uni0240	Contours detected: 3	Expected: 1
...
Glyph name: uni03A8	Contours detected: 2	Expected: 1
...
Glyph name: uni0470	Contours detected: 2	Expected: 1
Glyph name: uni048C	Contours detected: 3	Expected: 2
Glyph name: uni048D	Contours detected: 1	Expected: 2
...
Glyph name: uniE0FF	Contours detected: 2	Expected: 7
...
* ⚠ **WARN** The combined length of family and style exceeds 27 chars in the following 'WINDOWS' entries: FONT_FAMILY_NAME = 'Inter ExtraLight  BETA' / SUBFAMILY_NAME = 'Italic'
* ⚠ **WARN** Please take a look at the conversation at https://github.com/googlefonts/fontbakery/issues/2179 in order to understand the reasoning behing these name table records max-length criteria.
...
[('uni0418', 2073.0928, 2048.0), ('uni040D', 2073.0928, 2048.0), ('uni0419', 2073.0928, 2048.0), ('uni04E2', 2073.0928, 2048.0), ('uni04E4', 2073.0928, 2048.0), ('uni048A', 2073.0928, 2048.0), ('uni0376', 2036.0928, 2048.0), ('uni01A7', 133.51369999999997, 367.0), ('uni1E70', 277.72350000000006, -539.0), ('uni018C', 1590.0928, 2048.0), ('uni00EE', 77.72349999999994, 1715.0), ('uni1E3D', -285.27649999999994, -539.0), ('uniE05C', -271.27649999999994, -539.0), ('uni01A8', 1246.497, 1270.0), ('uni1E71', -10.276499999999942, -539.0), ('uni042F', 1637.0928, 2048.0), ('uni025C', 1346.0721, 1311.0), ('uni025E', 1369.0721, 1311.0), ('uni02C6', 367.72349999999994, 1714.0), ('uni0302', -971.2765, 1714.0), ('uni032D', -1346.2765, -539.0), ('uni01B8', 1763.0928, 2048.0), ('uni01B8', -37.15409999999997, 69.0), ('uni01B9', 110.57230000000004, -107.0)]
...
* ℹ **INFO** Could not detect which version of ttfautohint was used in this font. It is typically specified as a comment in the font version entries of the 'name' table. Such font version strings are currently: ['Version 3.008;git-d069a9f60']
...
* ℹ **INFO** Version string is: "Version 3.008;git-d069a9f60"
...
* ℹ **INFO** This font contains the following optional tables [fpgm, prep, gasp, loca, cvt , GSUB, GPOS]
...
* 🍞 **PASS** Inter-ExtraLightItalic.ttf is named canonically.
...
* 🍞 **PASS** Postscript name "Inter-ExtraLightItalicBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ('Inter' in 'Inter Extra Light Italic BETA')
