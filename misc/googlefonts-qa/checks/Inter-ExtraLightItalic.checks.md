...
* 🔥 **FAIL** Filename "Inter-ThinItalic.ttf" is listed on METADATA.pb but an actual font file with that name was not found. [code: file-not-found]
...
<details>
<summary><b>[132] Inter-ExtraLightItalic.ttf</b></summary>
<details>
...
objc[71643]: Objective-C garbage collection is no longer supported.
...
* 🔥 **FAIL** METADATA.pb font filename = "Inter-ExtraLightItalic.ttf" does not match post_script_name="Inter-ExtraLightItalicBETA". [code: mismatch]
...
* 🔥 **FAIL** METADATA.pb postScriptName ("Inter-ExtraLightItalicBETA") does not match correct font name format ("Inter ExtraLightBETA"). [code: mismatch]
...
* 🔥 **FAIL** Font macStyle Italic bit is set but nameID 4 ("Inter ExtraLightItalicBETA") is not ended with "Italic". [code: bad-fullfont-name]
...
* 🔥 **FAIL** OS/2 usWeightClass (200:"bad Google Fonts API weight value") does not match weight specified at METADATA.pb (200:"ExtraLight"). [code: mismatch]
...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the "name" table: Expected "Inter ExtraLight" but got "Inter ExtraLightBETA". [code: mismatch]
...
* 🔥 **FAIL** Entry [FULL_FONT_NAME(4):WINDOWS(3)] on the "name" table: Expected "Inter ExtraLight Italic"  but got "Inter ExtraLightItalicBETA". [code: bad-entry]
...
* 🔥 **FAIL** Entry [POSTSCRIPT_NAME(6):WINDOWS(3)] on the "name" table: Expected "Inter-ExtraLightItalic" but got "Inter-ExtraLightItalicBETA". [code: bad-entry]
...
* 🔥 **FAIL** TYPOGRAPHIC_SUBFAMILY_NAME for Win "ExtraLightItalicBETA" is incorrect. It must be "ExtraLight Italic". [code: bad-typo-win]
...
* 🔥 **FAIL** On the 'name' table, the full font name (NameID 4 - FULL_FONT_NAME: 'Inter ExtraLightBETA') does not begin with font family name (NameID 1 - FONT_FAMILY_NAME: 'Inter ExtraLightItalicBETA') [code: does-not]
...
Glyph name: uni0404	Contours detected: 3	Expected: 1
...
Glyph name: uni0488	Contours detected: 7	Expected: 8
...
Glyph name: uni1E08	Contours detected: 3	Expected: 2
Glyph name: uni1EBE	Contours detected: 5	Expected: 3
Glyph name: uni04B0	Contours detected: 2	Expected: 1 [code: contour-count]
...
* ⚠ **WARN** The following glyphs have coordinates which are out of bounds:
	* ('uni018C', 97.14519999999993, 532.0)
	* ('uni01DD', 122, 491)
	* ('uni026F', 168, 261)
	* ('uni0071', 153.14519999999993, 532.0)
	* ('uni025E', 1376.6941, 1331.0)
	* ('uni025E', 58.42660000000001, 406.0)
	* ('uni2E18', -1, -153)
	* ('uni0259', 122, 491)
	* ('uni04D9', 122, 491) and ('uni04DB', 122, 491)
...
* ℹ **INFO** This font contains the following optional tables [fpgm, loca, GSUB, gasp, prep, cvt , DSIG, GPOS]
...
* 🍞 **PASS** Font fullname "Inter ExtraLightItalicBETA" is identical in METADATA.pb and on the TTF file.
...
* 🍞 **PASS** METADATA.pb font.full_name field contains font name in right format. ("Inter" in "Inter ExtraLightItalicBETA")
